...
#name csv
print('file name for dist ')
n_dist =input(str(""))
print('file name for blow ')
n_blow =input(str(""))
print('file name for check ')
n_check =input(str(""))
...
name_csv_check = n_check +".csv"

#define frame rate limit
frame_rate = 10

#define size of ArUco
print('what the size of marker in meter\nex. 0.2 m')
m_size = input()
markerLength = m_size #m
...
#text_field = ui.TextField(placeholder="Marker size in cm meter")
