...
def setting():
    ...
    button_set = ui.Button(title="Done")
    ...
    text_field1.center = (view2.width / 2, view2.height / 2)
    text_field1.flex = [
        ui.FLEXIBLE_BOTTOM_MARGIN,
        ui.FLEXIBLE_TOP_MARGIN,
        ui.FLEXIBLE_LEFT_MARGIN,
    ...
    text_field2.center = (view2.width / 2, view2.height / 2+150)
    text_field2.flex = [
        ui.FLEXIBLE_BOTTOM_MARGIN,
        ui.FLEXIBLE_TOP_MARGIN,
        ui.FLEXIBLE_LEFT_MARGIN,
    ...
    text_field3.center = (view2.width / 2, view2.height / 2+250)
    text_field3.flex = [
        ui.FLEXIBLE_BOTTOM_MARGIN,
        ui.FLEXIBLE_TOP_MARGIN,
        ui.FLEXIBLE_LEFT_MARGIN,
    ...
    text_field4.center = (view2.width / 2, view2.height / 2+250)
    text_field4.flex = [
        ui.FLEXIBLE_BOTTOM_MARGIN,
        ui.FLEXIBLE_TOP_MARGIN,
        ui.FLEXIBLE_LEFT_MARGIN,
